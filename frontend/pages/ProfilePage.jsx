  ...
  useEffect(() => {
    async function getUserInfo() {
      ...
      try {
        ...
        const endpoint = id ? `http://localhost:3000/api/users/${id}` : "http://localhost:3000/api/users/me"
    ...
    <div className='mt-5'>
      ...
      <div className='border-2 border-black rounded-md m-auto shrink-0 max-w-5xl'>
        ...
        <div className=' bg-blue-950 p-5 relative flex'>
            ...
            <h1 className='p-2 rounded-md absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-3xl'>{user && user.username}</h1>
